...
def main():
    ...
    df_AUG = load_generated_metadata('../data/HAM10000/HAM10000_metadata.csv', '../data/darkHAM')   # TODO: change the path to the right name 
    ...
    train_loader, val_loader, test_loader = get_dataloaders_4(train_ham_df, val_ham_df, test_ham_df,
    ...
    plot_loss(train_metrics, args.results_path, "model_5")

    # Save the model 
    #TODO: change the model path to the right name
    best_loss_ckpt = os.path.join(args.results_path, 'model5_best_loss.pth')
    ...
    best_acc_ckpt = os.path.join(args.results_path, 'model5_best_acc.pth')

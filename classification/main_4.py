...
parser.add_argument('--results_path', type=str, default='results/isalis/model_4', help='Path to save the results')
...
def main():
    ...
    df_AUG = load_generated_metadata('../data/HAM10000/HAM10000_metadata.csv', '../data/darkHAM_resnet')
    ...
    metrics_ddi = evaluate(model, test_ddi_loader, args.results_path, "model_4_ddi", device)
    metrics_ham = evaluate(model, test_ham_loader, args.results_path, "model_4_ham", device)
    print("Best model:")

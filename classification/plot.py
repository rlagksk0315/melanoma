...
def plot_prs(pr_df, results_path):
    plt.figure()
...
def plot_rocs(roc_df, results_path):
    plt.figure()
...
def main():
    ...
    with open('../results/(name)/main_3_classification/model_3_ddi_metrics.json', 'r') as f:
        ddi_metrics_3 = json.load(f)

    with open('../results/(name)/main_4_classification/model_4_ham_metrics.json', 'r') as f:
        ham_metrics_4 = json.load(f)
    with open('../results/(name)/main_4_classification/model_4_ddi_metrics.json', 'r') as f:
        ddi_metrics_4 = json.load(f)

    with open('../results/(name)/main_5_classification/model_5_ham_metrics.json', 'r') as f:
        ham_metrics_5 = json.load(f)
    with open('../results/(name)/main_5_classification/model_5_ddi_metrics.json', 'r') as f:
        ddi_metrics_5 = json.load(f)

    with open('../results/(name)/main_6_classification/model_6_ham_metrics.json', 'r') as f:
        ham_metrics_6 = json.load(f)
    with open('../results/(name)/main_6_classification/model_6_ddi_metrics.json', 'r') as f:
        ddi_metrics_6 = json.load(f)

    with open('../results/(name)/main_7_classification/model_7_ham_metrics.json', 'r') as f:
        ham_metrics_7 = json.load(f)
    with open('../results/(name)/main_7_classification/model_7_ddi_metrics.json', 'r') as f:
        ddi_metrics_7 = json.load(f)

    with open('../results/(name)/main_8_classification/model_8_ham_metrics.json', 'r') as f:
        ham_metrics_8 = json.load(f)
    with open('../results/(name)/main_8_classification/model_8_ddi_metrics.json', 'r') as f:
        ddi_metrics_8 = json.load(f)
    

    # HAM
    ham_pr_df = pd.DataFrame({'model_name': [1, 2, 3, 4, 5, 6, 7, 8],
                              'recall': [ham_metrics_1['r'], ham_metrics_2['r'],
                                         ham_metrics_3['r'], ham_metrics_4['r'],
                                         ham_metrics_5['r'], ham_metrics_6['r'],
                                         ham_metrics_7['r'], ham_metrics_8 ['r'],],
                              'precision': [ham_metrics_1['p'], ham_metrics_2['p'],
                                            ham_metrics_3['p'], ham_metrics_4['p'],
                                            ham_metrics_5['p'], ham_metrics_6['p'],
                                            ham_metrics_7['p'], ham_metrics_8 ['p'],]})
    
    ham_pr_df = pd.DataFrame({'model_name': [1, 2, 3, 4, 5, 6, 7, 8],
                              'fpr': [ham_metrics_1['fpr'], ham_metrics_2['fpr'],
                                      ham_metrics_3['fpr'], ham_metrics_4['fpr'],
                                      ham_metrics_5['fpr'], ham_metrics_6['fpr'],
                                      ham_metrics_7['fpr'], ham_metrics_8 ['fpr'],],
                              'tpr': [ham_metrics_1['tpr'], ham_metrics_2['tpr'],
                                      ham_metrics_3['tpr'], ham_metrics_4['tpr'],
                                      ham_metrics_5['tpr'], ham_metrics_6['tpr'],
                                      ham_metrics_7['tpr'], ham_metrics_8 ['tpr'],]})
    ...
    plot_prs(ham_pr_df, results_path_ham) # HAM PR
    plot_rocs(ham_pr_df, results_path_ham) # HAM ROC
    plot_prs(ddi_pr_df, results_path_ddi) # DDI PR
    plot_rocs(ddi_pr_df, results_path_ddi) # DDI ROC

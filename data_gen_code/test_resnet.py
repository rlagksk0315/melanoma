...
test_image_path = "../data/darkHAM_resnet"  # Path to save generated images
model_path = "../results/resnet_cgan/FINAL/best_cyclegan_model.pth"  # Path to your saved model

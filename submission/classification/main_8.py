import torch
import os
from data_loading import load_ddi_metadata, load_generated_metadata, split_data, get_dataloaders_8, get_pos_ratio
...
parser.add_argument('--results_path', type=str, default='../results/model_8', help='Path to save the results')
